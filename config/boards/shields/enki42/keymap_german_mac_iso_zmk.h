...
#define DE_CIRC &kp GRAVE // TILDE (dead)
#define DE_1 &kp N1       // 1
#define DE_2 &kp N2       // 2
#define DE_3 &kp N3       // 3
#define DE_4 &kp N4       // 4
...
#define DE_9 &kp N9       // 9
#define DE_0 &kp N0       // 0
#define DE_SS &kp MINUS   // SIGNO DE MENOS -
#define DE_ACUT &kp EQUAL // ´ (dead) SIGNO IGUAL
// Row 2
#define DE_Q &kp Q       // Q
#define DE_W &kp W       // W
#define DE_E &kp E       // E
...
#define DE_O &kp O       // O
#define DE_P &kp P       // P
#define DE_UDIA &kp LBKT // left bracket[
#define DE_PLUS &kp RBKT // rigth braket ]
// Row 3
#define DE_A &kp A            // A
#define DE_S &kp S            // S
#define DE_D &kp D            // D
...
#define DE_QUES &kp QMARK   // ?
//#define DE_GRV  &kp LS(EQUAL) // ` (dead)
// Row 2
#define DE_ASTR &kp LS(RBKT) // *
#define DE_STAR &kp ASTRK // "*" DE_ASTR
// Row 3
//#define DE_QUOT &kp LS(BSLH) // '
// Row 4
#define DE_RABK &kp GT // >
//#define DE_SCLN &kp LS(COMMA) // ;
#define DE_COLN &kp LS(SEMICOLON)  // :
#define DE_UNDS &kp LS(MINUS) // _
